...
$query = 'SELECT customers.customerID, addresses.customerID, customers.emailAddress, customers.firstName, customers.lastName, addresses.line1, addresses.city, addresses.state, addresses.zipCode, addresses.phone
FROM addresses
INNER JOIN customers ON customers.customerID = addresses.customerID
GROUP BY customers.customerID, addresses.customerID, customers.emailAddress, customers.firstName, customers.lastName, addresses.line1, addresses.city, addresses.state, addresses.zipCode, addresses.phone;';
